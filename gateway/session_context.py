...
_CRON_MUTATION_GUARD: ContextVar = ContextVar("HERMES_CRON_MUTATION_GUARD", default=_UNSET)
_CRON_MUTATION_GUARD_OWNER_PID: ContextVar = ContextVar("HERMES_CRON_MUTATION_GUARD_OWNER_PID", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_CRON_MUTATION_GUARD": _CRON_MUTATION_GUARD,
    "HERMES_CRON_MUTATION_GUARD_OWNER_PID": _CRON_MUTATION_GUARD_OWNER_PID,
}
